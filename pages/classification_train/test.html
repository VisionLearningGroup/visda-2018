...
<?php
  ...
  /** settings **/
  $images_dir = 'ai.bu.edu/visda-2017/pages/classification_train/preload-images/';
  $thumbs_dir = 'ai.bu.edu/visda-2017/pages/classification_train/preload-images-thumbs/';
  $thumbs_width = 200;
  $images_per_row = 3;
